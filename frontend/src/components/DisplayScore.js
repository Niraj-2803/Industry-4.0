  ...
  return (
    <div className="relative inline-flex items-center justify-center">
      ...
      <div className="absolute flex flex-col items-center">
        <span className="text-3xl font-semibold text-gray-200">{percentage.toFixed(1)}<span className="text-3xl text-gray-400">%</span></span>
      </div>
    </div>
  );
};
...
const DisplayScore = () => {
  ...
  const phaseData = {
    phase1: 45, // 45% complete
    phase2: 32, // 32% complete
    phase3: 28, // 28% complete
    phase4: 21  // 21% complete
  };

  // Phase descriptions
  const phaseDescriptions = {
    phase1: "Your systems show foundational connectivity but require enhanced integration between operational technology and IT systems.",
    phase2: "Data visibility needs improvement to enable better real-time monitoring and decision making across your production processes.",
    phase3: "Your predictive capabilities are developing. Advanced analytics could help forecast maintenance needs and production outcomes.",
    phase4: "Autonomous systems adoption is in early stages. Focus on implementing self-optimizing processes for greater adaptability."
  };
